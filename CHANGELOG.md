...
- Hardened direct player-target Telegram deliveries for greetings, whispers, creature replies and social signals so a blocked-user private send no longer fails the action queue.
