...
- `start_cellar_root_pocket` intentionally uses `z = -1` as a tiny safe root pocket below the starter cellar. It is a MAP-004 light/examine proof, not a loot room: no ordinary resources, no cache, no combat and no broad route system.
