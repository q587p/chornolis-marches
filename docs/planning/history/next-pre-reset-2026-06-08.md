...
> Historical archive: this is the full pre-reset `docs/planning/next.md` captured on 12026-06-08 before the planning surface reset. Keep it for reference, but use `docs/planning/next.md`, `docs/planning/watchpoints.md` and `docs/planning/post_0_16_lane.md` for current steering.
