...
- `WORLD-003` should make hunger increase gradually with internal game time as well as from strenuous actions, with player-facing text kept atmospheric rather than debug-like.
