...
- 0.14.3 follow-up: player/admin-created ordinary campfires now degrade after they expire instead of remaining permanent location features forever. A згасле handmade campfire keeps a two in-game day ash lifetime, becomes almost invisible during the final two in-game hours, and disappears from ordinary location lists unless refreshed with fuel or relit. Seeded old campfires are exempt and remain authored memory/omen landmarks.
