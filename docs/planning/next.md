...
- MONEY-001/LOOT-001: `0.15.16` adds the first small money and local low-risk loot MVP: `shah`/`hryvnia` resource names, starter-adjacent `shah` finds, pickup support, a separate beginner-cache money box and a rare waking-world gather bonus. Keep next loot work focused on authored small finds, empty-search text, item lifetime and later offering/omen hooks; shops, vendors, prices, conversion, theft and broad economy remain out of scope.
...
- Local low-risk loot: `LOOT-001` has its first `MONEY-001` MVP slice after `0.15.16`. Review the next step as small authored find objects, empty-search atmosphere, item lifetime or offering hooks, not as a shop/economy expansion.
