...
- APIARY-001/APIARY-002: `0.15.19` adds the first old log apiary / `Стара бортя` in the dry meadow and a rare passive bumblebee sting hazard around it. Honey/wax robbery (`APIARY-003`) and the bear honey loop (`APIARY-004`) remain follow-up work, not part of the first hazard slice.
