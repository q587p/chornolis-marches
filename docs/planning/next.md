...
- NOTIF-001: `0.15.8` adds short coalescing for visible non-player movement notifications so camp spirits/NPCs do not produce repeated arrival/departure messages and stale target buttons during quick vertical moves.
- ANIMAL-001: `0.15.8` adds the first directed-speech reaction slice for animals; keep richer wolf escalation and context-sensitive behavior in the follow-up.
