...
- The starter border camp points upward to a watchtower with a temporary infinite torch stand under its awning, while the closed settlement gate keeps a downgraded old emergency stand. Their feature action is `Взяти факел`; later they should become limited-stock containers or bundles. The watchtower stand exists as first-session safety after darkness starts hiding details and is now the hunter resupply source.
