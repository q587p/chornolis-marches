...
- The starter border camp and the closed settlement gate both have temporary infinite torch stands. Their feature action is `Взяти факел`; later they should become limited-stock containers or bundles. The camp stand exists as first-session safety after darkness starts hiding details; do not remove the gate stand until hunter routes and gate-side supply are reviewed together.
