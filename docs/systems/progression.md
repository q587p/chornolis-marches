...
learning thresholds and stops once the player has already made a real brewing
attempt. It is a learning/onboarding nudge only, not a recipe book, quest marker,
NPC brewing route or public skill sheet.
