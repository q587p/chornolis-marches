...
assert.match(heraldAdminCommands, /\/archive_republish_gap/);
...
assert.match(heraldAdminHelp, /\/archive_republish_gap/);
...
assert.doesNotMatch(heraldPublicHelp, /\/archive_republish_gap/);
