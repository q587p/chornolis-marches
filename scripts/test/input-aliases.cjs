...
assert.equal(parseStartActionPayload("cmd_spirit_on"), "spiritOn");
assert.equal(parseStartActionPayload("cmd_spirit_off"), "autoStop");
assert.equal(parseStartActionPayload("cmd_spirit_stop"), "autoStop");
assert.equal(parseStartActionPayload("cmd_dukh"), "spirit");
assert.equal(parseStartActionPayload("cmd_dukh_on"), "spiritOn");
assert.equal(parseStartActionPayload("cmd_dukh_off"), "autoStop");
...
assert.equal(parseStartActionPayload("cmd_sleep_tutorial"), "sleepTutorial");
assert.equal(parseStartActionPayload("cmd_lie"), "lie");
assert.equal(parseStartActionPayload("cmd_track"), "track");
assert.equal(parseStartActionPayload("cmd_track_fox"), "trackFox");
assert.equal(parseStartActionPayload("cmd_signals"), "signals");
assert.equal(parseStartActionPayload("cmd_socials"), "signals");
assert.equal(parseStartActionPayload("cmd_follow"), "follow");
assert.equal(parseStartActionPayload("cmd_follow_assist_on"), "followAssistOn");
...
assert.equal(parseStartActionPayload("cmd_brew_tincture"), "brewTincture");
assert.equal(parseStartActionPayload("cmd_make_tincture"), "brewTincture");
assert.equal(parseStartActionPayload("cmd_attack_all"), "attackAll");
assert.equal(parseStartActionPayload("cmd_kill_all"), "killAll");
assert.equal(parseStartActionPayload("cmd_attack_all_mouse"), "attackAllMouse");
assert.equal(parseStartActionPayload("cmd_kill_all_mouse"), "killAllMouse");
assert.equal(parseStartActionPayload("cmd_attack_all_rabbit"), "attackAllRabbit");
assert.equal(parseStartActionPayload("cmd_kill_all_rabbit"), "killAllRabbit");
assert.equal(parseStartActionPayload("cmd_attack_all_frog"), "attackAllFrog");
assert.equal(parseStartActionPayload("cmd_kill_all_frog"), "killAllFrog");
assert.equal(parseStartActionPayload("cmd_attack_all_snake"), "attackAllSnake");
assert.equal(parseStartActionPayload("cmd_kill_all_snake"), "killAllSnake");
assert.equal(parseStartActionPayload("cmd_attack_all_fox"), "attackAllFox");
assert.equal(parseStartActionPayload("cmd_kill_all_fox"), "killAllFox");
assert.equal(parseStartActionPayload("cmd_attack_all_wolf"), "attackAllWolf");
assert.equal(parseStartActionPayload("cmd_kill_all_wolf"), "killAllWolf");
assert.equal(parseStartActionPayload("cmd_attack_all_owl"), "attackAllOwl");
assert.equal(parseStartActionPayload("cmd_kill_all_owl"), "killAllOwl");
assert.equal(parseStartActionPayload("cmd_attack_all_hawk"), "attackAllHawk");
assert.equal(parseStartActionPayload("cmd_kill_all_hawk"), "killAllHawk");
...
assertAlias("/drink tincture", { kind: "use-item", item: "herbal_tincture" });
assertAlias("/drink_tincture", { kind: "use-item", item: "herbal_tincture" });
assertAlias("/use tincture", { kind: "use-item", item: "herbal_tincture" });
assertAlias("/use_tincture", { kind: "use-item", item: "herbal_tincture" });
assertAlias("випити настоянку", { kind: "use-item", item: "herbal_tincture" });
assert.equal(inventoryResourceKeyFromText("трав’яна настоянка"), "herbal_tincture");
assert.equal(inventoryResourceKeyFromText("трав’яну настоянку"), "herbal_tincture");
...
assertAlias("/spirit", { kind: "auto", mode: "show" });
assertAlias("/dukh", { kind: "auto", mode: "show" });
assertAlias("/poklyk", { kind: "auto", mode: "show" });
assertAlias("дух", { kind: "auto", mode: "show" });
assertAlias("поклик духа", { kind: "auto", mode: "show" });
assertAlias("/spirit_on", { kind: "auto", mode: "start" });
assertAlias("/dukh_on", { kind: "auto", mode: "start" });
assertAlias("spirit on", { kind: "auto", mode: "start" });
assertAlias("покликати духа", { kind: "auto", mode: "start" });
assertAlias("дух веде", { kind: "auto", mode: "start" });
assertAlias("/spirit_off", { kind: "auto", mode: "stop" });
assertAlias("/spirit_stop", { kind: "auto", mode: "stop" });
assertAlias("/dukh_off", { kind: "auto", mode: "stop" });
...
assert.equal(formatAliasSuggestion(suggestAliasEntries("стоп ав")[0]), "стоп авто (/spirit_off)");
assert.equal(formatAliasSuggestion(suggestAliasEntries("авто ст")[0]), "авто стоп (/spirit_off)");
assert.equal(formatAliasSuggestion(suggestAliasEntries("вимкнути авт")[0]), "вимкнути авто (/spirit_off)");
assert.equal(formatAliasSuggestion(suggestAliasEntries("авт")[0]), "авто (/spirit)");
assert.equal(formatAliasSuggestion(suggestAliasEntries("увімкнути авт")[0]), "увімкнути авто (/spirit_on)");
