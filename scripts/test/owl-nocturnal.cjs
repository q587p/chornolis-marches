...
assert.equal(predatorKillObserverText("fox", "миша", "лис"), "Лис кидається на здобич. За мить миша падає нерухомо.");
assert.equal(predatorKillObserverText("fox", "жаба", "лис"), "Лис кидається на здобич. За мить жаба падає нерухомо.");
assert.equal(predatorMissObserverText("fox", "зайця", "заєць", "лис"), "Лис кидається на зайця, але здобич вислизає.");
assert.equal(predatorWoundObserverText("fox", "зайця", "заєць", "лис"), "Лис нападає на зайця.");
