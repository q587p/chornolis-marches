...
const restoredOnlyMice = planPopulationFloorRestoration({
  species,
  locations,
  livingCountsBySpeciesKey: { rabbit: 1, mouse: 0, fox: 1, wolf: 1, owl: 1 },
...
const noDuplicates = planPopulationFloorRestoration({
  species,
  locations,
  livingCountsBySpeciesKey: { rabbit: 3, mouse: 3, fox: 1, wolf: 1, owl: 1 },
  livingBreedingBySpeciesKey: {
    rabbit: { adultFemales: 1, adultMales: 1 },
...
const restoredNoRabbitPair = planPopulationFloorRestoration({
  species,
  locations,
  livingCountsBySpeciesKey: { rabbit: 2, mouse: 3, fox: 1, wolf: 1, owl: 1 },
  livingBreedingBySpeciesKey: {
...
const restoredNoMousePair = planPopulationFloorRestoration({
  species,
  locations,
  livingCountsBySpeciesKey: { rabbit: 3, mouse: 5, fox: 1, wolf: 1, owl: 1 },
  livingBreedingBySpeciesKey: {
    rabbit: { adultFemales: 1, adultMales: 1 },
