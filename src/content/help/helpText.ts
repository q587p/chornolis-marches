export const HELP_TEXT = [
  ...
  "• <i>Сліди лисиці</i> (/track_fox) — відфільтрувати сліди за істотою чи персонажем.",
  ...
  "• <i>Приготувати настоянку</i> (/brew tincture, /make_tincture) — спробувати зробити трав’яну настоянку з пляшечки, лікарських трав і ягід; <i>Випити настоянку</i> (/drink_tincture, <i>випити настоянку</i>) — випити готову настоянку для відновлення снаги.",
  "• <i>Черга</i> (/queue) — поточний план дій; /queue_cancel скасовує поточну дію, /queue_clear очищає чергу.",
  "• <i>Поклик духа</i> (/spirit) — показати поточний стан поклику й обраний шепіт; /spirit_on просить тихий шепіт час від часу обирати прості дії, а /spirit_off або <i>подякувати духу</i> відпускають його.",
  "",
  "<b>Навчання й увага</b>",
  "• Навички ростуть від дії й уважности: спроба, помилка або чужа робота поруч можуть навчити без сухих чисел.",
  "• <i>Слідувати</i> (/follow) тримає в увазі видиму істоту чи персонажа; <i>Слідування</i> (/follow_assist_on) можна ввімкнути окремо, але воно повторює лише звичайні видимі кроки.",
  "• Наставник не вчить самою згодою: дивіться, як місцеві працюють, і пробуйте поруч, коли місцина дає таку нагоду.",
  "• <i>Гурт</i> (/group) — домовленість мандрівників про спільний шлях; це не наказ ногам і не спільна черга дій.",
  "• Трав’яні настоянки вже можна готувати й пити через <i>Приготувати настоянку</i> (/make_tincture) та <i>Випити настоянку</i> (/drink_tincture, <i>випити настоянку</i>); інші зілля лишаються окремими уроками.",
  "• Бій теж може вчити тілом і оком: власна атака або справжня сутичка поруч іноді лишає досвід, але без таблиць і обіцянки перемоги.",
  "",
  ...
  "• <i>Сигнали</i> (/signals, сигнали) — короткі жести без окремої цілі; після <i>Роздивитися</i> оберіть персонажа чи істоту, щоб кивнути, помахати або подати жест саме їм.",
  "",
  "<b>Поради</b>",
...
export const COMMANDS_TEXT_PAGES = [
  [
    ...
    "• /crawl, пролізти, пролізти в щілину — обережно пройти вузьким проходом, якщо місцина вже показала таку можливість.",
    ...
    "• /track, /track кіт, /track_fox, сліди, відстежити — побачити свіжі сліди поруч або відфільтрувати їх за істотою чи персонажем.",
  ...
  [
    ...
    "• /brew tincture, /make_tincture, зробити настоянку, приготувати зілля — спробувати приготувати трав’яну настоянку з порожньої пляшечки, лікарських трав і ягід.",
    "• /drink tincture, /use tincture, випити настоянку — випити готову трав’яну настоянку для сильного відновлення снаги.",
    ...
    "• /auto, /spirit, авто, дух, поклик духа — показати поточний стан Поклику духа, обраний шепіт і команди керування.",
    "• /spirit_on, spirit on, покликати духа, дух веде — покликати духа до простих самостійних дій.",
    "• /spirit_off, /spirit_stop, подякувати духу, відпустити духа — відпустити поклик.",
    ...
    "",
    "Соціальні сигнали:",
    "• /signals, signals, socials, сигнал, сигнали — відкрити короткі жести без окремої цілі.",
...
export function helpTextForTutorialStatus(tutorialCompleted: boolean) {
