export const HELP_TEXT = [
  ...
  "• <i>Приготувати настоянку</i> (/brew tincture, /make_tincture) — спробувати зробити трав’яну настоянку з пляшечки, лікарських трав і ягід; /drink tincture або /use tincture — випити готову настоянку для відновлення снаги.",
