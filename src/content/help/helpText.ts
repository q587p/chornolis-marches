export const HELP_TEXT = [
  ...
  "• <i>Приготувати настоянку</i> (/brew tincture, /make_tincture) — спробувати зробити трав’яну настоянку з пляшечки, лікарських трав і ягід; <i>Випити настоянку</i> (/drink_tincture) — випити готову настоянку для відновлення снаги.",
