export const HELP_TEXT = [
  ...
  "• <i>Поклик духа</i> (/spirit) — показати поточний стан поклику й обраний шепіт; /spirit_on просить тихий шепіт час від часу обирати прості дії, а /spirit_off, <i>подякувати духу</i>, /auto_stop або <i>стоп авто</i> відпускають його.",
  "",
...
export const COMMANDS_TEXT_PAGES = [
  ...
  [
    ...
    "• /auto, /spirit, /dukh, авто, дух, поклик духа — показати поточний стан Поклику духа, обраний шепіт і команди керування.",
    "• /spirit_on, /dukh_on, spirit on, покликати духа, дух веде — покликати духа до простих самостійних дій.",
    "• /spirit_off, /dukh_off, /spirit_stop, подякувати духу, відпустити духа; також legacy /auto_stop, стоп авто — відпустити поклик.",
