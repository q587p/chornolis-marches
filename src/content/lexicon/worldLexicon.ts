...
export const WORLD_LEXICON = [
  ...
  entry("resource.honey", "resource", "MASCULINE", "INANIMATE", ["resource", "apiary", "future"], ["мед", "меду", "меду", "мед", "медом", "меді", "меде"]),
  entry("resource.beeswax", "resource", "MASCULINE", "INANIMATE", ["resource", "apiary", "future"], ["віск", "воску", "воску", "віск", "воском", "воску", "воску"]),
