...
export const WORLD_LEXICON = [
  ...
  entry("animal.snake", "creature", "FEMININE", "ANIMATE", ["animal", "swamp", "predator", "current"], ["змія", "змії", "змії", "змію", "змією", "змії", "зміє"]),
  ...
  entry("animal.hawk", "creature", "MASCULINE", "ANIMATE", ["animal", "bird", "predator", "day", "current"], ["сокіл", "сокола", "соколу", "сокола", "соколом", "соколі", "соколе"]),
  entry("animal.frog", "creature", "FEMININE", "ANIMATE", ["animal", "swamp", "prey", "current"], ["жаба", "жаби", "жабі", "жабу", "жабою", "жабі", "жабо"]),
  ...
  entry("resource.herbal_tincture", "resource", "FEMININE", "INANIMATE", ["resource", "bottles", "herbalism", "tincture", "current"], ["трав’яна настоянка", "трав’яної настоянки", "трав’яній настоянці", "трав’яну настоянку", "трав’яною настоянкою", "трав’яній настоянці", "трав’яна настоянко"]),
