...
export const ADMIN_HELP_TEXT = [
  ...
  "/addItem <resourceKey> [персонаж] [кількість] — додати будь-який відомий resourceKey у речі собі або вказаному персонажу; без кількості додає 1; для пляшечок використовуйте empty_bottle",
