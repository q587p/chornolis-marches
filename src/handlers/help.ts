...
export const HELP_TEXT = [
  ...
  "5. У Речах ягоди трохи повертають снагу, гриби вгамовують голод, лікарські трави можна прикласти при пораненні, а факел — запалити, якщо поруч є вогонь.",
  ...
  "• /stat — коротка статистика світу й посилання на повну веб-сторінку.",
  "• /who — хто був активний за останню реальну годину.",
  "• /sleep tutorial — повернутися до навчального сну. Поки навчання не завершене, /sleep також веде туди.",
