...
export const HELP_TEXT = [
  ...
  "6. Можна просто /sit, а коли втомилися або поранені — /rest чи кнопку 🧘 Відпочити.",
  "",
  "<b>Корисні команди</b>",
...
export const COMMANDS_TEXT_PAGES = [
  [
    ...
    "• /put туша рів, покласти всі рештки до ями — покласти тушу чи рештки з Речей у місцеву позначену особливість, зараз передусім у падальний рів біля воріт.",
