...
export const COMMANDS_TEXT_PAGES = [
  ...
  [
    ...
    "• /afk, afk, відійти — поставити сесію на паузу й зупинити нагадування.",
    "• /end_session, /quit, /leave, завершити сесію, вийти — завершити поточну Telegram-сесію.",
    ...
    "• freshen corpse, butcher corpse, освіжити труп, розібрати труп — обробити свіжий труп і здобути м'ясо; freshen all, свіжувати все — поставити всі придатні туші в чергу по одній.",
    "",
    "Соціальні сигнали:",
