...
export const HELP_TEXT = [
  ...
  "• <i>AFK / відійти</i> (/afk) — поставити сесію на паузу й зупинити нагадування; після 13 хвилин тиші це вмикається саме. Пасивний голод не зупиняється.",
  ...
  "• <i>Слідувати</i> (/follow) — позначити видиму істоту чи персонажа як чужий слід, за яким ви уважно стежите; /unfollow відпускає цей намір.",
  ...
  "• <i>Поклик духа</i> (/spirit) — попросити тихий шепіт Порубіжжя час від часу обирати прості дії; /spirit_stop, <i>подякувати духу</i>, /auto_stop або <i>стоп авто</i> відпускають його.",
  "",
  ...
  "• <i>Налаштування</i> (/settings) — керування сповіщеннями, зокрема повідомленнями про зміну часу дня й повідомленнями Поклику.",
...
export const COMMANDS_TEXT_PAGES = [
  [
    ...
    "• /follow знахар, follow herbalist, слідувати за знахарем, йти за Нестором — позначити видиму істоту чи персонажа як того, за чиїм рухом ви уважно стежите; /unfollow, відстати — відпустити цей намір.",
  ...
  [
    ...
    "• /search_honey, /search_beeswax, search honey, search beeswax, взяти мед, шукати мед, обібрати вулик, пограбувати бортю, добути віск — ризикована спроба дістати мед або віск зі старої борті.",
    ...
    "• /auto, авто — показати поточний стан Поклику духа, обраний шепіт і команди керування.",
    "• /spirit, /dukh, поклик духа, покликати духа, дух веде — покликати духа до простих самостійних дій.",
    "• /spirit_stop, /dukh_stop, подякувати духу, відпустити духа; також legacy /auto_stop, стоп авто — відпустити поклик.",
