...
export const HELP_TEXT = [
  ...
  "• <i>Повернення</i> (/refresh) — якщо заблукали, попросити стежку повернути вас до межового табору; перед переносом буде підтвердження.",
...
export const COMMANDS_TEXT_PAGES = [
  [
    ...
    "• /refresh, /respawn, повернення, повернутися до табору — підтверджене повернення до межового табору для заблукалих ранніх/виснажених персонажів.",
