...
export const COMMANDS_TEXT_PAGES = [
  [
    ...
    "• /give сире м'ясо коту, give raw meat to cat, дати сире м'ясо коту, /feed_raw_meat — передати одну підтриману річ видимій цілі; зараз це сире м'ясо для Кота-бережника.",
