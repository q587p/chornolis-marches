...
export const HELP_TEXT = [
  ...
  "5. Коли втомилися або поранені — /rest чи кнопку 🧘 Відпочити.",
  "",
  "<b>Корисні команди</b>",
  "• /me — стан персонажа, HP, снагу, голод, речі і статистика.",
  "• /look — озирнутися в поточній місцині.",
  "• /location або /loc — старі сумісні назви для /look.",
  "• /examine — роздивитися уважніше.",
