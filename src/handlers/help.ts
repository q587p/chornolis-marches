...
export const HELP_TEXT = [
  ...
  "",
  "<b>Персонаж</b>",
  "• Персонаж (/me) — стан персонажа, життя, снага, голод і короткий огляд речей.",
  "• Речі (/inventory) — тут можна з'їсти, використати, роздивитися або викинути наявні речі.",
  "• Відпочити (/rest) — сісти й почати короткий відпочинок.",
  "• Сісти (/sit) і Встати (/stand) — змінити поставу без окремої дії з речами.",
  "",
  "<b>Місцина і мапа</b>",
  "• Озирнутися (/look) — побачити поточну місцину.",
  "• Глянути швидко (/glance) — назва місцини та виходи без довгого опису.",
  "• Виходи (/exits) — лише видимі шляхи з місцини.",
  "• Роздивитися (/examine) — уважніший огляд місцини, предмета, істоти або особливості.",
  "• Сліди (/track) — пошукати свіжі сліди поруч.",
  "• Мапа — окремої ігрової мапи ще немає; поки найкраще звіряти виходи, читати описи й вести власні нотатки.",
  "",
  "<b>Рух і дії</b>",
  "• Північ (/north), Південь (/south), Захід (/west), Схід (/east) — рух сторонами світу. Коротко: /n, /s, /w, /e.",
  "• Зібрати (/gather) — збирати ягоди, гриби чи лікарські трави, якщо вони є поруч.",
  "• Черга (/queue) — поточний план дій; /queue_cancel скасовує поточну дію, /queue_clear очищає чергу.",
  "• Авто (/auto) — увімкнути самостійні дії; /auto_stop вимикає їх.",
  "",
  "<b>Мова і присутність</b>",
  "• Сказати (/say) — сказати щось у місцині.",
  "• Прошепотіти (/whisper) — тихо звернутися до видимого персонажа чи істоти.",
  "• Відповісти (/reply) — відповісти тому, хто останнім звернувся саме до вас.",
  "• Гукнути (/shout) — гукнути ширше, в межах регіону.",
  "• Сигнали — після Роздивитися оберіть персонажа чи істоту, щоб кивнути, помахати або подати інший короткий жест.",
  "",
  "<b>Світ і довідка</b>",
  "• Новини (/news) — остання новина й заголовки попередніх.",
  "• Хто поруч у часі (/who) — хто був активний за останню реальну годину.",
  "• Час (/time) — календарний відгук світу.",
  "• Команди (/commands) — повніший список текстових команд і аліасів.",
  "• Почати спочатку (/restart) — стерти персонажа і пройти шлях з початку через /start.",
].join("\n");
