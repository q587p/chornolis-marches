...
export const HERALD_COMMANDS: HeraldCommandInfo[] = [
  ...
  { command: "/archive_republish_gap", description: "звірити deployed news.md із видимими архівними публікаціями", adminOnly: true },
  { command: "/archive_republish_continue_preview", description: "переглянути безпечне продовження хвоста архіву", adminOnly: true },
  { command: "/archive_republish_continue", description: "поставити пропущений хвіст архіву в чергу", adminOnly: true },
  ...
  { command: "/publication_queue_status", description: "показати повний стан скрині публікацій", adminOnly: true },
  { command: "/future_publications", description: "показати майбутні записи скрині публікацій", adminOnly: true },
  { command: "/pending_publications", description: "показати записи, готові до публікації зараз", adminOnly: true },
...
export function formatHeraldHelp(isAdmin: boolean) {
  ...
  return [
    ...
    section("Архів news.md", [
      ...
      commandLine("/archive_republish_gap", "показати пропущені deployed архівні записи"),
      commandLine("/archive_republish_continue_preview <інтервал>", "переглянути продовження пропущеного хвоста"),
      commandLine("/archive_republish_continue <інтервал>", "поставити пропущений хвіст у чергу"),
    ...
    section("Черга й публікації", [
      commandLine("/publication_queue_status", "показати повний стан outbox: усього, готові зараз, майбутні, sourceType і pause"),
      commandLine("/future_publications", "показати наступні 10 майбутніх PUBLIC записів"),
      commandLine("/pending_publications", "показати записи в outbox, готові зараз"),
    ...
    section("Приклади", [
      ...
      "/archive_republish_continue 30m — поставити тільки пропущений хвіст архіву в чергу",
