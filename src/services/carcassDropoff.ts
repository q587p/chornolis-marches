...
export const HUNTER_FIELD_LINES = {
  departure: [
    ...
    "Перевірю край, доки слід ще теплий.",
    "Не дамо мишам думати, що ворота самі.",
    "Поки в траві шарудить надміру, хтось мусить вийти.",
    "Спис не для похвальби. Сьогодні він для межі.",
    "Краще один тихий обхід, ніж потім крик біля воріт.",
    "Піду подивлюся, хто там розучився боятися людей.",
    "Світло тримайте ближче. Я піду трохи далі.",
  ],
  trail: [
    "Звір розійшовся занадто близько до воріт.",
    "Поки хижаків мало, люди стануть зубами краю.",
    "Допоможемо лісовику втримати край.",
    "Слід веде низько, але не губиться.",
    "Трава тут лягає не від вітру.",
    "Де миша стежку втоптала, там заєць потім не сховається.",
    "Якщо чуєш тишу, слухай ще раз.",
    "Свіжий помет, свіжа біда.",
    "Не всякий рух видно очима. Деякий чути під підошвою.",
    "Хто їсть край без міри, той лишає більше знаків, ніж думає.",
  ],
  return: [
    "Падальний рів сьогодні не пустуватиме.",
    "Не за срібло йду, а щоб трава знову піднялася.",
    "Здобич легка, але знак для стада важкий.",
    "Не всяка робота має бути гучною.",
    "Повертаюся, доки м'ясо ще не забрало нічне.",
    "Край сьогодні дихатиме рівніше.",
    "Буде що скласти під кілок.",
    "Не геройство. Просто чергова зарубка.",
  ],
  deposit: [
    "Писарю, став зарубку.",
    "Ще трохи тиску на стадо.",
    "Запиши без прикрас: край трохи відтиснули назад.",
    "Цього досить для однієї короткої тиші.",
    "Хай рів пам'ятає, чому його викопали.",
    "Не рахуйте голосно. Ліс і так чує.",
    "Здобич у рів, а нам далі дивитися.",
    "Коли трава підведеться, тоді й подякуємо.",
  ],
  giveUp: [
    "Сліди розсипались. Повернуся іншим колом.",
    "Сьогодні ліс не дав легкої стежки.",
    "Порожній обхід теж щось каже.",
    "Не наздоганяй те, що вже стало шумом.",
    "Краще повернутися з порожніми руками, ніж загубити дорогу.",
    "Звір пішов чисто. Значить, не дурний.",
    "Сьогодні вітер на їхньому боці.",
    "Повернуся, поки темрява не почала рахувати мене.",
  ],
  standDown: [
    ...
    "Спис теж має відпочивати, інакше рука починає брехати.",
    "Коли край сам тримається, не треба штовхати його плечем.",
    "Нехай ніч трохи перемеле наші сліди.",
    "Сьогодні не женемо все, що ворушиться.",
    "Біля вогню видно, скільки зайвого ми вже наробили.",
    "Добрий мисливець знає, коли не йти.",
    "Поки вистачить. Межа не любить жадібних рук.",
  ],
} as const;
