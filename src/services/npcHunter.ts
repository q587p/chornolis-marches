...
export const HUNTER_CONVERSATION_REPLY_LINES = [
  ...
  "Якщо питаєш про шлях, спершу скажи, звідки вітер у спину.",
  "Не бий звіра тільки тому, що побачив. Спершу зрозумій, чому він тут.",
  "Порожній ліс небезпечніший за гучний: у гучному хоч знаєш, де хто.",
  "Не тягни здобич далеко без потреби. Ніч любить чуже м'ясо.",
  "Коли бачиш свіжий слід, не наступай на нього вдруге.",
  "Ліхтар у руці не робить тебе сміливішим. Він тільки чесніше показує страх.",
  "Якщо миша не тікає, значить, або дурна, або їх тут забагато.",
  "Зайця легко недооцінити. Він не слабкий, він швидко боїться.",
  "Не всі хижаки мають шерсть. Деякі носять хороші чоботи.",
  "Коли край просить тиші, навіть спис треба нести нижче.",
  "Слухай птахів. Вони першими знають, де ліс став порожнім.",
  "Питай коротко, й відповідь легше донести назад живою.",
];
