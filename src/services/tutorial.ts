...
export const TUTORIAL_ATTENTION_LOCATION_KEY = "dream_tutorial_attention_path";
export const TUTORIAL_SIGNS_LOCATION_KEY = "dream_tutorial_signs";
export const TUTORIAL_TRACES_LOCATION_KEY = "dream_tutorial_traces";
export const TUTORIAL_END_LOCATION_KEY = "dream_tutorial_waking_edge";
...
export async function completeTutorialForPlayer(playerId: number, reason = "tutorial-end") {
  ...
  return {
    ...
    text: [
      ...
      "",
      "Підказки про незавершене навчання більше не триматимуться за вас. Якщо колись захочеться повернутися до сну для повторення, напишіть <i>навчальний сон</i> (/sleep_tutorial).",
    ].join("\n"),
  };
}
