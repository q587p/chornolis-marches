...
export function buildAdminItemsReplyKeyboard() {
  return new Keyboard()
    .text("🍓 Додати ягоди в речі")
    .text("🌿 Додати трави в речі")
    .row()
    .text("🍄 Додати гриби в речі")
    .text("🌾 Додати траву в речі")
    .row()
    .text("🕯 Додати факел")
    .text("🔥🕯 Додати запалений факел")
    .row()
    .text("🕯 Додати притушений факел")
    .text("🪵 Додати хмиз")
    .row()
    .text("🥩 Додати сире м'ясо")
    .text("🍖 Додати смажене м'ясо")
    .row()
    .text("🍯 Додати мед")
    .text("🕯 Додати віск")
    .row()
